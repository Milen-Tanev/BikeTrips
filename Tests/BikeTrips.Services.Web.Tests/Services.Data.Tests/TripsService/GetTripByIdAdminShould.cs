namespace BikeTrips.Services.Web.Tests.Services.Data.Tests.TripsService
{
    ...
    [TestFixture]
    public class GetTripByIdAdminShould
    {
        ...
        public void CallIdentifierProviderGetIdMethodOnce()
        {
            ...
            //Act
            service.GetTripByIdAdmin(It.IsAny<string>());
        ...
        public void ReturnCorrectTrip()
        {
            ...
            //Act
            var resultTrip = service.GetTripByIdAdmin(It.IsAny<string>());
        ...
        public void TripsRepositoryGetByIdMethodIsCalledOnce()
        {
            ...
            var tripMock = new Mock<Trip>();
            tripsRepositoryMock.Setup(r => r.GetByIdWithDeleted(It.IsAny<int>()))
                .Returns(tripMock.Object);
            ...
            //Assert
            tripsRepositoryMock.Verify(r => r.GetByIdWithDeleted(It.IsAny<int>()),
                Times.Once);
        }
    }
}
